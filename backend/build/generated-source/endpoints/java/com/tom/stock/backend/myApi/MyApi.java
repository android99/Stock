 ...
 * on 2016-07-15 at 02:12:22 UTC 
 * Modify at your own risk.
 */

package com.tom.stock.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public Login login(java.lang.String userid, java.lang.String passwd) throws java.io.IOException {
    Login result = new Login(userid, passwd);
    initialize(result);
    return result;
  }

  public class Login extends MyApiRequest<com.tom.stock.backend.myApi.model.LoginValidation> {

    private static final String REST_PATH = "login/{userid}/{passwd}";
     ...
     * @since 1.13
     */
    protected Login(java.lang.String userid, java.lang.String passwd) {
      super(MyApi.this, "POST", REST_PATH, null, com.tom.stock.backend.myApi.model.LoginValidation.class);
      this.userid = com.google.api.client.util.Preconditions.checkNotNull(userid, "Required parameter userid must be specified.");
      this.passwd = com.google.api.client.util.Preconditions.checkNotNull(passwd, "Required parameter passwd must be specified.");
    }
    ...
    public Login setPasswd(java.lang.String passwd) {
      this.passwd = passwd;
      return this;
    }
  ...
  public class SayHi extends MyApiRequest<com.tom.stock.backend.myApi.model.MyBean> {
    ...
    protected SayHi(java.lang.String name) {
      super(MyApi.this, "POST", REST_PATH, null, com.tom.stock.backend.myApi.model.MyBean.class);
